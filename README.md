...
3. TERP gave *negative* returns in both 2017 (-7.2%) and 2018 (-5.0%). Therefore, it should be avoided.
4. DQ provided best return in 2017 (199.4%) but the worst return in 2018 (-62.6%). Therefore, it has the *highest variation* and hence needs to be studied further before investing.
